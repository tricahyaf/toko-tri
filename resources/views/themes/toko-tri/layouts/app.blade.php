...
<head>
    ...
    <title>Toko-Tri: Official Site</title>
    @vite(['resources/sass/app.scss', 'resources/js/app.js', 'resources/css/themes/layouts.css'])
</head>
<body>
    <nav class="navbar navbar-expand-lg bg-white fixed-top py-4 shadow-sm">
      <div class="container">
        <a class="navbar-brand" href="index.html">Toko-Tri</span></a>
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="{{ asset('public/themes/toko-tri/assets/img/slide1.jpg') }}" class="d-block w-100" alt="slide 1">
            </div>
            <div class="carousel-item">
              <img src="{{ asset('public/themes/toko-tri/assets/img/slide2.jpg') }}" class="d-block w-100" alt="slide 2">
            </div>
          </div>
        ...
        <div class="row mt-5">
          <div class="col-lg-3 col-6">
            <div class="card card-product card-body p-lg-4 p3">
              <a href="product.html"><img src="{{ asset('public/themes/toko-tri/assets/img/shop_01.jpg') }}" alt="" class="img-fluid"></a>
          ...
          <div class="col-lg-3 col-6">
            <div class="card card-product card-body p-lg-4 p3">
              <a href="product.html"><img src="{{ asset('public/themes/toko-tri/assets/img/shop_02.jpg') }}" alt="" class="img-fluid"></a>
          ...
          <div class="col-lg-3 col-6 mt-3 mt-lg-0">
            <div class="card card-product card-body p-lg-4 p3">
              <a href="product.html"><img src="{{ asset('public/themes/toko-tri/assets/img/shop_03.jpg') }}" alt="" class="img-fluid"></a>
          ...
          <div class="col-lg-3 col-6 mt-3 mt-lg-0">
            <div class="card card-product card-body p-lg-4 p3">
              <a href="#"><img src="{{ asset('public/themes/toko-tri/assets/img/shop_04.jpg') }}" alt="" class="img-fluid"></a>
    ...
    <section class="latest">
      <div class="container">
        ...
        <div class="row mt-5">
          ...
          <div class="col-lg-3 col-6 mt-3 mt-lg-0">
            <div class="card card-product card-body p-lg-4 p3">
              <a href="product.html"><img src="{{ asset('public/themes/toko-tri/assets/img/shop_04.jpg') }}" alt="" class="img-fluid"></a>
              <h3 class="product-name mt-3">Product 4</h3>
              <div class="rating">
                <i class="bx bxs-star"></i>
                <i class="bx bxs-star"></i>
    ...
    <footer>
      <div class="container pt-5">
        <div class="row row-content">
          <div class="col-md-6">
            <h1 class="logo-brand">Toko-Tri</span></h1>
          ...
          <div class="col-md-3 mt-4 mt-sm-0">
            ...
            <a href="#">tricahya644@gmail.com</a>
            <p>Cikalahang, Dukupuntang, Cirebon</p>
          </div>
        </div>
        <div class="row row-copy mt-4 mt-sm-0">
          <div class="col-md-6">
            <p>&copy; 2023 Toko-Tri. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
